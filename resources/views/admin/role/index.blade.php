                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="btn-group mb-2">
                            <a href="{{route('roles.create')}}" class="btn btn-primary"><i class="fas fa-plus"></i> Agregar</a>
                        </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 50px;">
                                        ...
                                        <a class="jsgrid-button jsgrid-edit-button edit" href="{{route('roles.edit', $role)}}" title="Editar">
