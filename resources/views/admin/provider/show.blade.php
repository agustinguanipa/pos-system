...
<div class="content-wrapper">
    <div class="page-header">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Panel de Administración</a></li> <li class="breadcrumb-item"><a href="{{route('providers.index')}}">Proveedores</a></li>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-footer info-text">
                    <a href="{{route('providers.index')}}" class="btn btn-primary float-left">Regresar</a>
                </div>
            </div>
        </div>
    </div>
