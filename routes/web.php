...
Route::resource('bussinesses', 'BusinessController')->names('businesses')->only(['index', 'update']);
...
Route::post('sales/reports_results', 'ReportController@reports_results')->name('reports.results');
